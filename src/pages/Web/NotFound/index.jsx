    ...
    return (
      <Row className="not-found" justify="center">
        ...
        <div className="not-found--footer">
          ...
          <div className="not-found--footer--description">{t("not_found.description")}</div>
          <Link className="not-found--footer--button" to="/">
            <RightCircleFilled className="not-found--footer--button__icon" />{" "}
            {t("not_found.button_go_home")}
          </Link>
        </div>
      </Row>
    );
